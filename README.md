...
### База данных едина для всех, схема бд выложена в репозитории, название 1135_inventory_system
...
- **Моё оборудование:** 
  ...
  - "Провести инвентаризацию" подразумевает - обновление данных об оборудовании, с обновлением даты в поле LastInventoryDate
- **Инвентаризация:**
